    ...
    <main>
        ...
        ?>
            <section class="popular-products">
                ...
                <div class="container">
                    <div class="section-title">
                        <h2><?php echo esc_html(get_theme_mod('set_popular_title', __('Popular products', 'aura-lab'))); ?></h2>
                    </div>
                    <?php
            ...
            <section class="new-arrivals">
                <div class="container">
                    <div class="section-title">
                        <h2><?php echo esc_html(get_theme_mod('set_new_arrivals_title', __('New Arrivals', 'aura-lab'))); ?></h2>
                    </div>
                    <?php
                    ...
                    <div class="container">
                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="deal-desc col-md-4 col-12 mr-auto text-center">
                                <?php if (!empty($sale)) : ?>
                                    <span class="discount">
                                        <?php echo esc_html($discount_percentage); ?><?php esc_html_e('% OFF', 'aura-lab') ?>
                                    </span>
                                <?php endif; ?>
                                <h3>
                                ...
                                <a href="<?php echo esc_url('?add-to-cart=' . $deal); ?>" class="add-to-cart"><?php esc_html_e('Add to Cart', 'aura-lab') ?></a>
                            </div>
                        </div>
                    </div>
                </section>
        ...
        <section class="lab-blog">
            <div class="container">
                <div class="section-title">
                    <h2><?php echo esc_html(get_theme_mod('set_blog_title', __('News From Our Blog', 'aura-lab'))); ?></h2>
                </div>
                <div class="row">
                    <?php
                    $args = array(
                    ...
                    ?>
                            <article class="col-12 col-md-6">
                                <a href="<?php the_permalink() ?>">
                                    ...
                                    if (has_post_thumbnail()) :
                                        the_post_thumbnail('aura-lab-blog', array('class' => 'img-fluid'));
                                    endif;
                                    ?>
                                </a>
                                <h3>
                        ...
                        ?>
                        <p><?php esc_html_e('Nothing to display', 'aura-lab') ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </section>
